      ...
      <div className="fixed top-0 left-0 right-0 bg-[#052127] border-b border-gray-200 z-50">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <Link
              to="/"
              className="flex items-center justify-center space-x-2 text-white text-2xl"
            >
              {/* <svg
                width="19"
                height="20"
            ...
            <div className="hidden md:flex items-center text-base space-x-8">
              <Link
                ...
                className={`${isActive(
                  "/"
                )} hover:text-[#00add1] transition-colors`}
              >
                Home
              </Link>
              <Link
              ...
              <InteractiveHoverButton
                className="bg-gradient-to-r from-[#003e4b] to-[#00ff99] w-40 text-base border-none hover:border-2 hover:border-white"
                text="Join Waitlist"
                onClick={() => {
                  setIsModalOpen(true);
                }}
      ...
      >
        <div className="container mx-auto px-4">
          <div className="py-6 space-y-4">
            <Link
              to="/"
              className="block text-white px-3 py-2 rounded-md hover:text-black hover:bg-purple-50 transition-colors"
              onClick={() => setIsMenuOpen(false)}
            >
              Home
            </Link>
            ...
            <Link
              to="/"
              className="block px-3 py-2 text-white rounded-md hover:text-black hover:bg-purple-50 transition-colors"
              onClick={() => setIsMenuOpen(false)}
            >
              Roadmap
            </Link>
